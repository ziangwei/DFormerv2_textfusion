...
parser.add_argument("--enable-text-guidance", dest="enable_text_guidance", default=None, action=argparse.BooleanOptionalAction, help="Enable/disable text fusion (overrides config)")
...
with Engine(custom_parser=parser) as engine:
    try:
        ...
        if args.enable_text_guidance is not None:
            config.enable_text_guidance = bool(args.enable_text_guidance)
